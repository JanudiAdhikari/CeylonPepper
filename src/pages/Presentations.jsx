...
const Presentations = () => {
  const slides = [
    ...
    { title: "Final Presentation", desc: "Comprehensive final presentation slides (25-26J-479_FinalPresentation.pdf).", file: getLink("1NMTkho66jRQwbD9WuKvWb_4s7mEqydAX") }
  ];

  return (
    <div className="container fade-in" style={{ padding: '40px 20px' }}>
      <div className="badge-container">
        <span className="section-badge">Presentations</span>
      </div>

...
const Documents = () => {
  const documentGroups = [
    ...
    },
    {
      ...
      icon: '📝',
      docs: [
        { title: "Yield Prediction", desc: "Component proposal report.", file: getLink("1gkcuHEHewXYLBB1W18goVWr727-1LHB_") },
        { title: "Disease Detection", desc: "Component proposal report.", file: getLink("1mUWZKkAVuH1LG_WHX7yxCZqBOYrisqbD") },
        { title: "Quality Grading", desc: "Component proposal report.", file: getLink("1WJN9L0VHIJVejdgwK2e3KAlKmBOMKPpg") },
        { title: "Price Forecasting", desc: "Component proposal report.", file: getLink("1EdGWYH8OxlttBy_CbUhWF1oYWjAR9nyI") },
      ],
    },
    {
    ...
    <div className="fade-in">
      <div className="milestones-hero">
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h1>Project <em style={{ fontStyle: 'italic', color: 'var(--secondary)' }}>Documents</em></h1>
          <p>Downloadable resources, reports and the finalized research paper for the CeylonPepper project.</p>
        </div>
      </div>
            ...
            <div className="card-grid">
              {group.docs.map((doc, i) => (
                <div className="download-card" key={i}>
                  ...
                  <h4>{doc.title}</h4>
                  <p>{doc.desc}</p>
                  <a href={doc.file} target="_blank" rel="noopener noreferrer" className="btn-download">
                    View PDF
                  </a>
                </div>
              ))}
